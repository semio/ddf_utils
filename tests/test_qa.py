...
def test_compare_func():
    ...
    d1 = DDFcsv.from_path(os.path.join(wd, 'chef/datasets/pkg/ddf--bp--energy@v0.0.1')).ddf
    d2 = DDFcsv.from_path(os.path.join(wd, 'chef/datasets/pkg/ddf--cme@v0.0.1')).ddf
