...
(ingredient :id "datapoints-connection_to_electricity"
            :dataset url
            :key "geo, year"
...
(procedure "dps-housing_unit_rates" cooking
           :procedure "run_op"
           :ingredients ["dps-housing_unit_merged"]
           :options {:op {
                          :housing_units_owned_percentage
...
(serve :ingredients ["dps-housing_unit_rates"
